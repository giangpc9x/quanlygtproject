...
<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="EditForm.aspx.cs" Inherits="GridEditing_EditForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="phContent" Runat="Server">
    ...
    <asp:CheckBox ID="cbNewRowLocation" runat="server" Checked="False" OnCheckedChanged="cbNewRowLocation_CheckedChanged" Text="Show New Item row at bottom" AutoPostBack="True" Width="100%"/>
    <br />
    <%-- EndRegion --%>
