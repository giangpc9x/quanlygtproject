...
<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="EditFormTemplate.aspx.cs" Inherits="GridEditing_EditFormTemplate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="phContent" Runat="Server">
    <dxwgv:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" DataSourceID="AccessDataSource1" KeyFieldName="EmployeeID" AutoGenerateColumns="False" OnRowUpdating="grid_RowUpdating" Width="100%" OnRowInserting="grid_RowInserting">
        <%-- BeginRegion Columns --%>
        <Columns>
