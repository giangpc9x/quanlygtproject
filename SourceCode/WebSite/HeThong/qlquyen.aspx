<%@ Page Title="" Language="C#" MasterPageFile="~/giaothong.master" AutoEventWireup="true" CodeFile="qlquyen.aspx.cs" Inherits="HeThong_qlquyen" %>
...
{
    if (gvQuyen.GetSelectedRowCount()) 
    {
        if (confirm('Xác nhận xóa dữ liệu'))
            gvQuyen.GetValuesOnCustomCallback("Delete", GetUpdateResult);
    }
    else
...
function GetUpdateResult(errorText) 
{
    if (errorText != "")
        alert(errorText);
    gvQuyen.PerformCallback("Update");
}
</script>
